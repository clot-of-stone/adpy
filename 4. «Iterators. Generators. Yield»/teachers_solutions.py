...
def test_task_1():
    ...
    for IteratorClass in (FlatIteratorV1, FlatIteratorV2, FlatIteratorV3,
                          FlatIteratorV4):
...
def test_task_2():
    ...
    for yield_function in (flat_generator_v1, flat_generator_v2,
                           flat_generator_v3, flat_generator_v4):
